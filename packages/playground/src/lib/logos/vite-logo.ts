...
export interface ViteLogo {
  width: string
  height: string
}

export class ViteLogo extends MinzeElement {
  attrs: Attrs = [
    ['width', 256],
    ['height', 257]
  ]
